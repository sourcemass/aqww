...
from Config import Join_CHANNEL, Channel_NAME, CHANNEL_SUDO
...
async def must_join_channel(bot: Client, msg: Message):
    ...
    try:
            ...
            try:
                await msg.reply(
                    ...
                    reply_markup=InlineKeyboardMarkup([
                        [InlineKeyboardButton(u"{Channel_NAME}", url=link)]
                    ])
                )
        ...
        print(f"عليك رفع البوت آدمن في القناة أولاً ؟؟ : {Join_CHANNEL} !")
